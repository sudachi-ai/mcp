import { $ as DEFAULT_NEGOTIATED_PROTOCOL_VERSION, $n as TaskCreationParamsSchema, $t as NotificationSchema, A as CallToolRequestParamsSchema, An as ResourceTemplateSchema, Ar as isJSONRPCResultResponse, At as JSONRPCResultResponseSchema, B as ClientResultSchema, Bn as SamplingMessageSchema, Br as OAuthErrorResponseSchema, Bt as ListResourcesResultSchema, C as schemaToJson, Cn as RequestSchema, Cr as getNotificationSchema, Ct as InitializeResultSchema, D as BaseMetadataSchema, Dn as ResourceRequestParamsSchema, Dr as isJSONRPCErrorResponse, Dt as JSONRPCNotificationSchema, E as AudioContentSchema, En as ResourceListChangedNotificationSchema, Er as isInitializedNotification, Et as JSONRPCMessageSchema, F as CancelledNotificationParamsSchema, Fn as RootSchema, Fr as resourceUrlFromServerUrl, Ft as ListPromptsRequestSchema, G as CompleteResultSchema, Gn as ServerTasksCapabilitySchema, Gr as OpenIdProviderDiscoveryMetadataSchema, Gt as ListToolsRequestSchema, H as CompatibilityCallToolResultSchema, Hn as ServerNotificationSchema, Hr as OAuthProtectedResourceMetadataSchema, Ht as ListRootsResultSchema, I as CancelledNotificationSchema, In as RootsListChangedNotificationSchema, Ir as OAuthClientInformationFullSchema, It as ListPromptsResultSchema, J as CreateMessageRequestSchema, Jn as SingleSelectEnumSchemaSchema, Jr as SafeUrlSchema, Jt as LoggingMessageNotificationParamsSchema, K as ContentBlockSchema, Kn as SetLevelRequestParamsSchema, Kr as OpenIdProviderMetadataSchema, Kt as ListToolsResultSchema, L as ClientCapabilitiesSchema, Ln as SUPPORTED_PROTOCOL_VERSIONS, Lr as OAuthClientInformationSchema, Lt as ListResourceTemplatesRequestSchema, M as CallToolResultSchema, Mn as ResourceUpdatedNotificationSchema, Mr as isTerminal, Mt as LATEST_PROTOCOL_VERSION, N as CancelTaskRequestSchema, Nn as ResultSchema, Nr as getDisplayName, Nt as LegacyTitledEnumSchemaSchema, O as BlobResourceContentsSchema, On as ResourceSchema, Or as isJSONRPCNotification, Ot as JSONRPCRequestSchema, P as CancelTaskResultSchema, Pn as RoleSchema, Pr as checkResourceAllowed, Pt as ListChangedOptionsBaseSchema, Q as CursorSchema, Qn as TaskAugmentedRequestParamsSchema, Qr as OAuthErrorCode, Qt as MultiSelectEnumSchemaSchema, R as ClientNotificationSchema, Rn as SamplingContentSchema, Rr as OAuthClientMetadataSchema, Rt as ListResourceTemplatesResultSchema, S as parseSchemaAsync, Sn as RequestIdSchema, Sr as assertCompleteRequestResourceTemplate, St as InitializeRequestSchema, T as AnnotationsSchema, Tn as ResourceLinkSchema, Tr as isInitializeRequest, Tt as JSONRPCErrorResponseSchema, U as CompleteRequestParamsSchema, Un as ServerRequestSchema, Ur as OAuthTokenRevocationRequestSchema, Ut as ListTasksRequestSchema, V as ClientTasksCapabilitySchema, Vn as ServerCapabilitiesSchema, Vr as OAuthMetadataSchema, Vt as ListRootsRequestSchema, W as CompleteRequestSchema, Wn as ServerResultSchema, Wr as OAuthTokensSchema, Wt as ListTasksResultSchema, X as CreateMessageResultWithToolsSchema, Xn as SubscribeRequestParamsSchema, Xr as SdkErrorCode, Xt as ModelHintSchema, Y as CreateMessageResultSchema, Yn as StringSchemaSchema, Yr as SdkError, Yt as LoggingMessageNotificationSchema, Z as CreateTaskResultSchema, Zn as SubscribeRequestSchema, Zr as OAuthError, Zt as ModelPreferencesSchema, _ as mergeCapabilities, _n as RELATED_TASK_META_KEY, _r as UnsubscribeRequestSchema, _t as IconSchema, a as createFetchWithInit, an as PrimitiveSchemaDefinitionSchema, ar as TextContentSchema, at as ElicitationCompleteNotificationParamsSchema, b as isOptionalSchema, bn as ReadResourceResultSchema, br as UrlElicitationRequiredError, bt as ImplementationSchema, c as validateAndWarnToolName, cn as ProgressSchema, cr as TitledSingleSelectEnumSchemaSchema, ct as EmptyResultSchema, d as deserializeMessage, dn as PromptListChangedNotificationSchema, dr as ToolExecutionSchema, dt as GetPromptRequestSchema, en as NumberSchemaSchema, er as TaskMetadataSchema, et as ElicitRequestFormParamsSchema, f as serializeMessage, fn as PromptMessageSchema, fr as ToolListChangedNotificationSchema, ft as GetPromptResultSchema, g as Protocol, gn as ProtocolErrorCode, gr as UnsubscribeRequestParamsSchema, gt as GetTaskResultSchema, h as DEFAULT_REQUEST_TIMEOUT_MSEC, hn as ProtocolError, hr as ToolUseContentSchema, ht as GetTaskRequestSchema, i as UriTemplate, in as PingRequestSchema, ir as TaskStatusSchema, it as ElicitResultSchema, j as CallToolRequestSchema, jn as ResourceUpdatedNotificationParamsSchema, jr as isTaskAugmentedRequestParams, jt as JSONRPC_VERSION, k as BooleanSchemaSchema, kn as ResourceTemplateReferenceSchema, kr as isJSONRPCRequest, kt as JSONRPCResponseSchema, l as validateToolName, ln as ProgressTokenSchema, lr as ToolAnnotationsSchema, lt as EnumSchemaSchema, m as toArrayAsync, mn as PromptSchema, mr as ToolSchema, mt as GetTaskPayloadResultSchema, n as AjvJsonSchemaValidator, nn as PaginatedRequestSchema, nr as TaskStatusNotificationParamsSchema, nt as ElicitRequestSchema, o as normalizeHeaders, on as ProgressNotificationParamsSchema, or as TextResourceContentsSchema, ot as ElicitationCompleteNotificationSchema, p as takeResult, pn as PromptReferenceSchema, pr as ToolResultContentSchema, pt as GetTaskPayloadRequestSchema, q as CreateMessageRequestParamsSchema, qn as SetLevelRequestSchema, qr as OptionalSafeUrlSchema, qt as LoggingLevelSchema, r as InMemoryTransport, rn as PaginatedResultSchema, rr as TaskStatusNotificationSchema, rt as ElicitRequestURLParamsSchema, s as issueToolNameWarning, sn as ProgressNotificationSchema, sr as TitledMultiSelectEnumSchemaSchema, st as EmbeddedResourceSchema, t as CfWorkerJsonSchemaValidator, tn as PaginatedRequestParamsSchema, tr as TaskSchema, tt as ElicitRequestParamsSchema, u as ReadBuffer, un as PromptArgumentSchema, ur as ToolChoiceSchema, ut as GetPromptRequestParamsSchema, v as getSchemaDescription, vn as ReadResourceRequestParamsSchema, vr as UntitledMultiSelectEnumSchemaSchema, vt as IconsSchema, w as unwrapOptionalSchema, wn as ResourceContentsSchema, wr as getRequestSchema, wt as InitializedNotificationSchema, x as parseSchema, xn as RelatedTaskMetadataSchema, xr as assertCompleteRequestPrompt, xt as InitializeRequestParamsSchema, y as getSchemaShape, yn as ReadResourceRequestSchema, yr as UntitledSingleSelectEnumSchemaSchema, yt as ImageContentSchema, z as ClientRequestSchema, zn as SamplingMessageContentBlockSchema, zr as OAuthClientRegistrationErrorSchema, zt as ListResourcesRequestSchema } from "./src-C2NRzboS.mjs";
...
var Server = class extends Protocol {
	...
	*/
	constructor(_serverInfo, options) {
		...
		if (this._capabilities.logging) this.setRequestHandler("logging/setLevel", async (request, ctx) => {
	...
	buildContext(ctx, transportInfo) {
		const hasHttpInfo = ctx.http || transportInfo?.requestInfo || transportInfo?.closeSSEStream || transportInfo?.closeStandaloneSSEStream;
		return {
			...ctx,
			mcpReq: {
				...ctx.mcpReq,
	...
	*/
	...
	assertRequestHandlerCapability(method) {
		...
		switch (method) {
			...
			case "tasks/result":
			case "tasks/cancel":
				if (!this._capabilities.tasks) throw new SdkError(SdkErrorCode.CapabilityNotSupported, `Server does not support tasks capability (required for ${method})`);
				break;
			case "ping":
	...
	async _oninitialize(request) {
		...
		return {
			protocolVersion: this._supportedProtocolVersions.includes(requestedVersion) ? requestedVersion : this._supportedProtocolVersions[0] ?? LATEST_PROTOCOL_VERSION,
...
var McpServer = class {
	...
	setToolRequestHandlers() {
		...
		this.server.setRequestHandler("tools/list", () => ({ tools: Object.entries(this._registeredTools).filter(([, tool]) => tool.enabled).map(([name, tool]) => {
			const toolDefinition = {
				...
				inputSchema: tool.inputSchema ? schemaToJson(tool.inputSchema, { io: "input" }) : EMPTY_OBJECT_JSON_SCHEMA,
				annotations: tool.annotations,
				execution: tool.execution,
				_meta: tool._meta
			};
			if (tool.outputSchema) toolDefinition.outputSchema = schemaToJson(tool.outputSchema, { io: "output" });
	...
	*/
	async validateToolInput(tool, args, toolName) {
		...
		if (!parseResult.success) {
			...
			throw new ProtocolError(ProtocolErrorCode.InvalidParams, `Input validation error: Invalid arguments for tool ${toolName}: ${errorMessage}`);
		}
	...
	*/
	async validateToolOutput(tool, result, toolName) {
		...
		if (!parseResult.success) {
			const errorMessage = parseResult.error.issues.map((i) => i.message).join(", ");
			throw new ProtocolError(ProtocolErrorCode.InvalidParams, `Output validation error: Invalid structured content for tool ${toolName}: ${errorMessage}`);
		}
	}
	/**
	...
	*/
	...
	async handlePromptCompletion(request, ref) {
		...
		const field = getSchemaShape(prompt.argsSchema)?.[request.params.argument.name];
...
var WebStandardStreamableHTTPServerTransport = class {
	...
	*/
	validateProtocolVersion(req) {
		...
		if (protocolVersion !== null && !this._supportedProtocolVersions.includes(protocolVersion)) return this.createJsonErrorResponse(400, -32e3, `Bad Request: Unsupported protocol version: ${protocolVersion} (supported versions: ${this._supportedProtocolVersions.join(", ")})`);
	}
	async close() {
...
//#endregion
export { AjvJsonSchemaValidator, AnnotationsSchema, AudioContentSchema, BaseMetadataSchema, BlobResourceContentsSchema, BooleanSchemaSchema, COMPLETABLE_SYMBOL, CallToolRequestParamsSchema, CallToolRequestSchema, CallToolResultSchema, CancelTaskRequestSchema, CancelTaskResultSchema, CancelledNotificationParamsSchema, CancelledNotificationSchema, CfWorkerJsonSchemaValidator, ClientCapabilitiesSchema, ClientNotificationSchema, ClientRequestSchema, ClientResultSchema, ClientTasksCapabilitySchema, CompatibilityCallToolResultSchema, CompleteRequestParamsSchema, CompleteRequestSchema, CompleteResultSchema, ContentBlockSchema, CreateMessageRequestParamsSchema, CreateMessageRequestSchema, CreateMessageResultSchema, CreateMessageResultWithToolsSchema, CreateTaskResultSchema, CursorSchema, DEFAULT_NEGOTIATED_PROTOCOL_VERSION, DEFAULT_REQUEST_TIMEOUT_MSEC, ElicitRequestFormParamsSchema, ElicitRequestParamsSchema, ElicitRequestSchema, ElicitRequestURLParamsSchema, ElicitResultSchema, ElicitationCompleteNotificationParamsSchema, ElicitationCompleteNotificationSchema, EmbeddedResourceSchema, EmptyResultSchema, EnumSchemaSchema, ExperimentalMcpServerTasks, ExperimentalServerTasks, GetPromptRequestParamsSchema, GetPromptRequestSchema, GetPromptResultSchema, GetTaskPayloadRequestSchema, GetTaskPayloadResultSchema, GetTaskRequestSchema, GetTaskResultSchema, IconSchema, IconsSchema, ImageContentSchema, ImplementationSchema, InMemoryTaskMessageQueue, InMemoryTaskStore, InMemoryTransport, InitializeRequestParamsSchema, InitializeRequestSchema, InitializeResultSchema, InitializedNotificationSchema, JSONRPCErrorResponseSchema, JSONRPCMessageSchema, JSONRPCNotificationSchema, JSONRPCRequestSchema, JSONRPCResponseSchema, JSONRPCResultResponseSchema, JSONRPC_VERSION, LATEST_PROTOCOL_VERSION, LegacyTitledEnumSchemaSchema, ListChangedOptionsBaseSchema, ListPromptsRequestSchema, ListPromptsResultSchema, ListResourceTemplatesRequestSchema, ListResourceTemplatesResultSchema, ListResourcesRequestSchema, ListResourcesResultSchema, ListRootsRequestSchema, ListRootsResultSchema, ListTasksRequestSchema, ListTasksResultSchema, ListToolsRequestSchema, ListToolsResultSchema, LoggingLevelSchema, LoggingMessageNotificationParamsSchema, LoggingMessageNotificationSchema, McpServer, ModelHintSchema, ModelPreferencesSchema, MultiSelectEnumSchemaSchema, NotificationSchema, NumberSchemaSchema, OAuthClientInformationFullSchema, OAuthClientInformationSchema, OAuthClientMetadataSchema, OAuthClientRegistrationErrorSchema, OAuthError, OAuthErrorCode, OAuthErrorResponseSchema, OAuthMetadataSchema, OAuthProtectedResourceMetadataSchema, OAuthTokenRevocationRequestSchema, OAuthTokensSchema, OpenIdProviderDiscoveryMetadataSchema, OpenIdProviderMetadataSchema, OptionalSafeUrlSchema, PaginatedRequestParamsSchema, PaginatedRequestSchema, PaginatedResultSchema, PingRequestSchema, PrimitiveSchemaDefinitionSchema, ProgressNotificationParamsSchema, ProgressNotificationSchema, ProgressSchema, ProgressTokenSchema, PromptArgumentSchema, PromptListChangedNotificationSchema, PromptMessageSchema, PromptReferenceSchema, PromptSchema, Protocol, ProtocolError, ProtocolErrorCode, RELATED_TASK_META_KEY, ReadBuffer, ReadResourceRequestParamsSchema, ReadResourceRequestSchema, ReadResourceResultSchema, RelatedTaskMetadataSchema, RequestIdSchema, RequestSchema, ResourceContentsSchema, ResourceLinkSchema, ResourceListChangedNotificationSchema, ResourceRequestParamsSchema, ResourceSchema, ResourceTemplate, ResourceTemplateReferenceSchema, ResourceTemplateSchema, ResourceUpdatedNotificationParamsSchema, ResourceUpdatedNotificationSchema, ResultSchema, RoleSchema, RootSchema, RootsListChangedNotificationSchema, SUPPORTED_PROTOCOL_VERSIONS, SafeUrlSchema, SamplingContentSchema, SamplingMessageContentBlockSchema, SamplingMessageSchema, SdkError, SdkErrorCode, Server, ServerCapabilitiesSchema, ServerNotificationSchema, ServerRequestSchema, ServerResultSchema, ServerTasksCapabilitySchema, SetLevelRequestParamsSchema, SetLevelRequestSchema, SingleSelectEnumSchemaSchema, StdioServerTransport, StringSchemaSchema, SubscribeRequestParamsSchema, SubscribeRequestSchema, TaskAugmentedRequestParamsSchema, TaskCreationParamsSchema, TaskMetadataSchema, TaskSchema, TaskStatusNotificationParamsSchema, TaskStatusNotificationSchema, TaskStatusSchema, TextContentSchema, TextResourceContentsSchema, TitledMultiSelectEnumSchemaSchema, TitledSingleSelectEnumSchemaSchema, ToolAnnotationsSchema, ToolChoiceSchema, ToolExecutionSchema, ToolListChangedNotificationSchema, ToolResultContentSchema, ToolSchema, ToolUseContentSchema, UnsubscribeRequestParamsSchema, UnsubscribeRequestSchema, UntitledMultiSelectEnumSchemaSchema, UntitledSingleSelectEnumSchemaSchema, UriTemplate, UrlElicitationRequiredError, WebStandardStreamableHTTPServerTransport, assertClientRequestTaskCapability, assertCompleteRequestPrompt, assertCompleteRequestResourceTemplate, assertToolsCallTaskCapability, checkResourceAllowed, completable, createFetchWithInit, deserializeMessage, getCompleter, getDisplayName, getNotificationSchema, getRequestSchema, getSchemaDescription, getSchemaShape, hostHeaderValidationResponse, isCompletable, isInitializeRequest, isInitializedNotification, isJSONRPCErrorResponse, isJSONRPCNotification, isJSONRPCRequest, isJSONRPCResultResponse, isOptionalSchema, isTaskAugmentedRequestParams, isTerminal, issueToolNameWarning, localhostAllowedHostnames, mergeCapabilities, normalizeHeaders, parseSchema, parseSchemaAsync, resourceUrlFromServerUrl, schemaToJson, serializeMessage, takeResult, toArrayAsync, unwrapOptionalSchema, validateAndWarnToolName, validateHostHeader, validateToolName };
